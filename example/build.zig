...
pub fn build(b: *std.Build) void {
    ...
    const zig_wasm_ffi_module = zig_wasm_ffi_dep.module("zig-wasm-ffi");
    exe.root_module.addImport("zig-wasm-ffi", zig_wasm_ffi_module);
    ...
    // Create a step to remove the dist directory if it exists
    ...
    clean_dist.step.dependOn(b.getInstallStep());
